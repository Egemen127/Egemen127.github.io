...
export default function MyProjects(){
    return (<div className="project-container">
        <div className="project">
            <img className="img-project"src={img1}/><img className="img-project" src={img2}/>
            <h2>Boarding Pass</h2>
        ...
        <div className="project">
            <img className="img-project"src={img3}/><img className="img-project" src={img4}/>
        ...
        <div className="project">
            <img className="img-project"src={img5}/><img className="img-project" src={img6}/>
            <h2>Hangman</h2>
        ...
        <div className="project">
            <img className="img-project"src={img7}/><img className="img-project" src={img8}/>
            <h2>HOBO.COM</h2>
        ...
        <div className="project">
            <img className="img-project"src={img9}/><img className="img-project" src={img10}/>
        ...
        <div className="project">
            <img className="img-project"src={img12}/><img className="img-project" src={img11}/>
