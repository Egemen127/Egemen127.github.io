...
export default function Bio(){
    return (
        <main>
        <div className="img-container"><img className="img-profile"src={image}/></div>
        <h2>Egemen Durmus</h2>
        <h4>Java Full Stack Developer</h4>
        <div className="button-container"><a href="https://www.github.com/Egemen127" target="_blank"><div className="button1">Github</div></a>
        <a href="https://www.linkedin.com/in/egemen-d-b80941180/" target="_blank"><div className="button2">Linkedin</div></a></div>
        <h3>About</h3>
